DROP DATABASE IF EXISTS easy_document;
CREATE DATABASE IF NOT EXISTS easy_document DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `database_info` VALUES (1149954992195629058, 'master', 'com.mysql.cj.jdbc.Driver', 'root', 'root', 'jdbc:mysql://127.0.0.1:3306/easy_document?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=CTT', '主数据源，项目启动数据源！', '2019-07-13 16:13:29');
COMMIT;
...
INSERT INTO `sys_config` VALUES (1145915627211370498, 'Guns发布的编号', 'GUNS_SYSTEM_RELEASE_VERSION', 'N', NULL, '20190729', '用于防止浏览器缓存相关的js和css', '2019-07-02 12:42:30', 1, NULL, NULL);
COMMIT;
